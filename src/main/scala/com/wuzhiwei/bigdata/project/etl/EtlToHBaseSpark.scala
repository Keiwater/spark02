...
object EtlToHBaseSpark {
  ...
  def main(args: Array[String]): Unit = {
    ...
    logger.warn(eventPutsRDD.first())
    ...
    eventPutsRDD.saveAsNewAPIHadoopFile(
      "/datas/spark/hbase/elt" + System.currentTimeMillis(), //
    ...
    // TODO: 当保存数据到HBase表中以后，可以考虑手动对HBase表的数据Flush操作
  ...
  /**
    * 手动Flush刷新MemStore中数据到StoreFile中
    * @param tableName
    *                  表的名称
    */
  def flushHBaseTable(tableName: String, conf: Configuration): Unit ={
