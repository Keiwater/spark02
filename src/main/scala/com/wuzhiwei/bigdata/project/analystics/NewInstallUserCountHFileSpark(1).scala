package com.wuzhiwei.bigdata.project.analystics
...
import com.wuzhiwei.bigdata.project.util.TimeUtil
    ...
    dayPlatformBrowserNewUserCountRDD.coalesce(1).foreachPartition(iter => {
      Try{
        ...
        val conn: Connection = {
          ...
          // 链接数据三要素
          val url: String = "jdbc:mysql://bigdata-training01.wuzhiwei.com:3306/test?characterEncoding=UTF-8"
